...
public class SecretariaService implements ISecretariaService {
	...
	public MensagemDTO alterarSecretaria (Long idSecretaria, AlteraSecretariaDTO alteraSecretariaDTO ) {
		...
		if (secretariaConsultada.isPresent()) {
			...
			secretariaAlterada.setOrcamentoProjetos(secretariaAlterada.getOrcamentoProjetos());
			secretariaAlterada.setOrcamentoFolha(secretariaAlterada.getOrcamentoFolha());
			secretariaAlterada.setTelefone(secretariaAlterada.getTelefone());
			secretariaAlterada.setEndereco(secretariaAlterada.getEndereco());
			secretariaAlterada.setSite(secretariaAlterada.getSite());
			secretariaAlterada.setEmail(secretariaAlterada.getEmail());
